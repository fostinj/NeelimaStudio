            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-right">Booking Details</h2>
                    </div>
    ...
    <div class="tile">
      ...
      <table id="data-table-command" class="table table-bordered table-vmiddle">
        ...
        <?php
                    ...
                    $sql="SELECT b.*,p.*,l.*,u.* FROM tbl_booking b JOIN tbl_package p ON p.package_id=b.package_id JOIN tbl_login l ON l.login_id=b.login_id JOIN tbl_ureg u ON u.login_id=l.login_id WHERE b.status='1' AND b.approve='0' ORDER BY p.package_name ASC";
          ...
          <tr>    
            ...
            <td><a href="approvebooking.php?id=<?php echo $row['booking_id'] ?>" class="btn btn-success">Approve</a></td>
          </tr>
          <?php
          $rowcount++;
          }
