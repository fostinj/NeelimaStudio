...
<?php
    ...
    $sql="SELECT * FROM tbl_ureg JOIN tbl_login ON tbl_ureg.login_id = tbl_login.login_id WHERE tbl_ureg.login_id=".$_GET['id'];
  ...
  <div class="container">
    ...
    <div class="tile" id="profile-main">
      <div class="pm-overview c-overflow-dark">
        <div class="pmo-pic">
          <div class="p-relative"> <a href="#"> <img class="img-responsive" src="../img/uploads/users/<?php echo $image ?>" alt=""> </a>
