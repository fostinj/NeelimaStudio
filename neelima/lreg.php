...
if(isset($_POST['submit']))
{
    ...
    move_uploaded_file($_FILES['image']['tmp_name'],"img/uploads/lab/".$image);
	...
	if(mysqli_num_rows($result2) > 0)
	{
        ...
        echo "<script type='text/javascript'>window.location.href = 'lreg.php'</script>";
	}
	else {
	    $password=SHA1($password);
		$sql1="insert into `tbl_login`(`email`, `password`, `user_id`,`status`) values ('$email','$password','4','1')";
		...
		$sql="insert into `tbl_lreg` (`lab_name`, `mobile`,`image`,`login_id` ) values ('$labName','$mobile','$image','$log_id')";
...
//         }
 ...
 function lName(){
            var lab_name=form1.lab_name.value;
                if((lab_name===null)||(lab_name.length<2)){
                    
                    alert("Enter Lab Name");
                    form1.lab_name.focus();
                    return false;
                }
                var lab_name=/^[a-zA-Z]{2,20}$/;
                if(form1.lab_name.value.search(lab_name)==-1)
                 {
...
//         }
       ...
       var lab_name= form1.lab_name.value;
                if((lab_name===null)||(lab_name.length<3)){
                    form1.lab_name.style.border = "1px solid red";
                    alert("Enter Lab Name");
                    form1.lab_name.focus();
                    return false;
                }
                var lab_name=/^[a-zA-Z ]{4,25}$/;
                if(form1.lab_name.value.search(lab_name)==-1)
                 {
                      alert("Enter Lab Name");
                      form1.lab_name.focus();
						...
						<div class="row">
							<div class="col-lg-8 col-md-8">
								...
								<form name="form1"  method="POST" action="#" id="form" enctype="multipart/form-data" onSubmit="return addUser()">
									<div class="mt-10">
										<input type="text" name="lab_name" id="lab_name" placeholder="Lab Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Lab Name'" required onChange="return fName()" class="single-input">
									</div>
                                    ...
                                    <div class="mt-10">
                                        <input type="file" name="image"  id="fileChooser" onchange="return ValidateFileUpload()" placeholder="Select Profile Picture" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Select Profile Picture'" required class="single-input">
