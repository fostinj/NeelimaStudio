...
?>
				...
				<div class="container">
					<div class="banner_content text-center">
						...
						<div class="page_link">
							...
							<a href="bookedpackage.php">Current Booking</a>
						</div>
					</div>
				</div>
            </div>
	...
	<section>
        ...
        //     $package = $result['package_id'];
            $sql2 = "select p.*,b.* from tbl_package p JOIN tbl_booking b ON b.package_id=p.package_id WHERE b.approve='0' and b.status='1' ORDER BY b.date ASC";
