...
<!-- Mirrored from frenify.com/envato/marketify/html/arlo/1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2019 06:40:15 GMT -->
<head>
...
<div class="arlo_tm_wrapper_all">
	...
	<div class="arlo_tm_content">
		...
		<!-- RIGHTPART -->
        <?php 
			$sql = "SELECT tbl_sreg.*,tbl_login.*,tbl_designation.* FROM tbl_sreg,tbl_login,tbl_designation WHERE tbl_sreg.login_id=tbl_login.login_id AND tbl_designation.designation_id=tbl_sreg.designation_id";
							...
							<div class="content hero">
								<div class="inner_content">
									<div class="image_wrap">
										<img src="../img/uploads/staff/<?php  echo $row['image']?>" alt="" />
									</div>
									<div class="name_holder">
										<h3><?php echo $row['first_name'] ?> <span><?php echo $row['last_name'] ?></span></h3>
									</div>
									<div class="text_typing">
										<p>I'm a <?php echo $row['designation_name'] ?></p>
									</div>
								</div>
							</div>
...
<!-- Mirrored from frenify.com/envato/marketify/html/arlo/1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2019 06:40:44 GMT -->
</html>